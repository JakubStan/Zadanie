...
class Populator {
  ...
  private function createDefaultSettings() {
    ...
    $currentLabelText = _x('Chcę otrzymywać ekskluzywne e-maile ze zniżkami i informacjami o produktach', "default email opt-in message displayed on checkout page for ecommerce websites", 'mailpoet');
